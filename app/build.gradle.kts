...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            storePassword = "Shanavas1."  // The password you entered
            keyAlias = "malikudy"
            keyPassword = "Shanavas1."    // The password you entered
        }
    }
    ...
    buildTypes {
        release {
            ...
            signingConfig = signingConfigs.getByName("release")  // ✅ Use signing config
        }
        debug {
